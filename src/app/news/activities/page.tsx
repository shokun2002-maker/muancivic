...
import { Sparkles, Calendar, ChevronRight, ArrowRight, ChevronLeft, Loader2 } from "lucide-react";
...
export default function ActivitiesListPage() {
  ...
  const listPosts = activities.filter((a) => a.id !== featuredPost?.id);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-xs font-bold text-gray-500">활동소식 데이터를 읽어오고 있습니다...</p>
          </div>
        ) : (
          <>
