          ...
          {GALLERY_ITEMS.map((item, idx) => (
            ...
            >
              ...
              <div className="relative aspect-video bg-gradient-to-br from-[#176B52]/20 via-gray-200 to-[#2878A7]/20 flex items-center justify-center overflow-hidden">
                ...
                <span className="absolute top-3 left-3 bg-black/60 text-white text-[11px] font-bold px-2.5 py-1 rounded-md backdrop-blur-sm">
                  {item.category}
                </span>
              ...
              <div className="p-5 flex-1 flex flex-col justify-between">
                ...
                <div className="flex items-center gap-1.5 text-xs text-[#666666] font-medium pt-3 border-t border-gray-200/60">
